...
const BuyBox = ({name,reference,stars,rating,price,priceDiscount,description,options,optionsShape = "square",optionsRadius = "4px",optionsType = "text",}) => {
    ...
    return (
        <div className="buy-box p-6  rounded-lg bg-[#F9F8FE] ">
            ...
            <div className="flex items-center mt-2">
                <div className="flex items-center bg-warning text-white text-[14px] rounded-lg px-2 py-1 mr-2">
                    {stars}
            ...
            <div>
                ...
                <div className="flex gap-2">
                    {options.map((option, index) => (
                        <button
                            key={index}
                            className={`flex items-center justify-center ${optionsShape === 'circle' ? 'w-8 h-8 rounded-full' : 'w-12 h-12 rounded-md'
